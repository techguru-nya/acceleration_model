...
CoEta._TorqueRatio._Gearbox._TransmissionModel._DriveSystem._xWD._20ms.PT_Model  nobit 1 key=CoEtaProp.FA unit=- scmin=0.100586 scmax=1.5
CoEta_Gearbox._TorqueRatio._Gearbox._TransmissionModel._DriveSystem._xWD._20ms.PT_Model  nobit 1 key=CoEtaProp.RA unit=- scmin=0.100586 scmax=1.5
+ exp=0
...
ABSActive  nobit 1 key=i_over_iDiff.RA unit=- scmin=0 scmax=1
+ exp=1
